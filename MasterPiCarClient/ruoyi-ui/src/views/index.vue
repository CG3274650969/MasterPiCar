    ...
    <el-row :gutter="20">
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log">
          ...
          <div class="body">
            <p>
              <i class="el-icon-s-promotion"></i> 前端网页：<el-link
            ...
            <p>
              <i class="el-icon-user-solid"></i> QQ号：
              <a href="http://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=EeCBXu51I1zPWRia2uskpjDRx6VrbnFN&authKey=Xm8yDxk0%2FyYGI11oxhXaQnTn4K7UwCk7Kn2MZTh3P1JxLctollAkyeySjnaILDkb&noverify=0&group_code=174569686" target="_blank">3274650969</a>
            </p>
            <p>
        ...
        <el-card class="update-log">
          ...
          <div class="body">
            ...
            <el-collapse accordion>
              <el-collapse-item title="v1.0.0 - 2015-1-07">
                <ol>
                  <li>完成任务书，初步确定工作任务</li>
                </ol>
              </el-collapse-item>
            </el-collapse>
